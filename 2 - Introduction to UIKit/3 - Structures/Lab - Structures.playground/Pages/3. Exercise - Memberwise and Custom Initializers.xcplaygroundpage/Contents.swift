...
let favoriteBook = Book(title: "The Great Gatsby", author: "F. Scott Fitzgerald", pages: 180, price: 12.99)
...
var smthHeight = Height(centimeters: 180)
print("Height in inches: \(smthHeight.heightInInches)")
print("Height in cm: \(smthHeight.heightInCentimeters)")
/*:
