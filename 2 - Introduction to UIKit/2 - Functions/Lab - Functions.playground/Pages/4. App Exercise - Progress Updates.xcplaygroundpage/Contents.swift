...
func progressUpdate(steps: Int, goal: Int) {
    let percentComplete = Double(steps) / Double(goal) * 100.0
...
progressUpdate(steps: 4000, goal: 8000)
...
pacing(currentDistance: 8.0, totalDistance: 16.0, currentTime: 75.0, goalTime: 120.0)
